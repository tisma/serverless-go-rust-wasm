(module
    ...
    (func $println (param $strptr i32) (param $len i32)
        ;; print the string pointed by $strptr
        ;;    fd = 1
    ...
    ;; show_env emits a single env var pair to stdout
